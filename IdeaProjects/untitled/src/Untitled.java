...
public class Untitled extends Frame{
...
//        } while (c != 'q');
    ...
    public static class WriteToFile extends Thread {

        WriteToFile() {};

        WriteToFile(int num) {
            System.out.println("Новый поток "+num);
            //setPriority(num+5);
            setName("thread-"+num+" prior:"+getPriority());
            start();
        }

        public synchronized void showThread() {
//            Thread t = Thread.currentThread();
//            for (int i=1;i<=7;i++) System.out.println(t.getName()+"["+i+"]");
//            try {
//                Thread.sleep(500);
//            }
//            catch (InterruptedException e) {}
            for (int i=1;i<=7;i++) new WriteToFile(i);
            //new WriteToFile(2);
            //new WriteToFile(3);
        }
...
//    }
    ...
    //public class AppWindow extends Frame {
        ...
        class MyKeyAdapter extends KeyAdapter {
            Untitled appWindow;
            public MyKeyAdapter(Untitled appWindow) {
        ...
        class MyMouseAdapter extends MouseAdapter {
            Untitled appWindow;
            public MyMouseAdapter(Untitled appWindow) {
                this.appWindow = appWindow;
            }
